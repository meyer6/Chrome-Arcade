...
function Game_State_Display(){
	...
	f.load().then(function(font) {   document.fonts.add(font)
		...
		if (typeof(Storage) !== "undefined") {
			var High_Score=window.localStorage.getItem('Tetris_user')
...
function clear_line(){             
	...
	if (typeof(Storage) !== "undefined") {
	    ...
	    if (score>int_High_Score){
	    	window.localStorage.setItem('Tetris_user', strscore);
	   	}
	} 
	var as=0;
    for (as=0;as<10;as++){
...
if (typeof(Storage) !== "undefined") {
	var colour3=window.localStorage.getItem('Tetris_colour3')
	if (colour3==null){
		...
		var High_Score=window.localStorage.getItem('Tetris_user')
		if (High_Score==null){
			window.localStorage.setItem('Tetris_user', "0");
		}
	}else{
		moving=true
		var Board=JSON.parse(window.localStorage.getItem('Tetris_Board'));
		var score=(JSON.parse(window.localStorage.getItem('Tetris_score')))[0];
		var colour=window.localStorage.getItem('Tetris_colour');
		var colour2=window.localStorage.getItem('Tetris_colour2');
		var block1=JSON.parse(window.localStorage.getItem('Tetris_block1'));
		var block2=JSON.parse(window.localStorage.getItem('Tetris_Block2'));
		var block3=JSON.parse(window.localStorage.getItem('Tetris_Block3'));
		var block4=JSON.parse(window.localStorage.getItem('Tetris_Block4'));
		var block1_reset=JSON.parse(window.localStorage.getItem('Tetris_block1_reset'));
		var block2_reset=JSON.parse(window.localStorage.getItem('Tetris_block2_reset'));
		var block3_reset=JSON.parse(window.localStorage.getItem('Tetris_block3_reset'));
		var block4_reset=JSON.parse(window.localStorage.getItem('Tetris_block4_reset'));
		...
		var holding1=window.localStorage.getItem('Tetris_holding5')
		if (holding1=='true'){
			var colour1=window.localStorage.getItem('Tetris_colour1');
			var colour21=window.localStorage.getItem('Tetris_colour21');
			var block11=JSON.parse(window.localStorage.getItem('Tetris_block11'));
			var block21=JSON.parse(window.localStorage.getItem('Tetris_block21'));
			var block31=JSON.parse(window.localStorage.getItem('Tetris_block31'));
			var block41=JSON.parse(window.localStorage.getItem('Tetris_block41'));
			var block1_reset1=JSON.parse(window.localStorage.getItem('Tetris_block1_reset1'));
			var block2_reset1=JSON.parse(window.localStorage.getItem('Tetris_block2_reset1'));
			var block3_reset1=JSON.parse(window.localStorage.getItem('Tetris_block3_reset1'));
			var block4_reset1=JSON.parse(window.localStorage.getItem('Tetris_block4_reset1'));
		...
		var colour3=window.localStorage.getItem('Tetris_colour3');
		var colour23=window.localStorage.getItem('Tetris_colour23');
		var block13=JSON.parse(window.localStorage.getItem('Tetris_block13'));
		var block23=JSON.parse(window.localStorage.getItem('Tetris_block23'));
		var block33=JSON.parse(window.localStorage.getItem('Tetris_block33'));
		var block43=JSON.parse(window.localStorage.getItem('Tetris_block43'));
		var block1_reset3=JSON.parse(window.localStorage.getItem('Tetris_block1_reset3'));
		var block2_reset3=JSON.parse(window.localStorage.getItem('Tetris_block2_reset3'));
		var block3_reset3=JSON.parse(window.localStorage.getItem('Tetris_block3_reset3'));
		var block4_reset3=JSON.parse(window.localStorage.getItem('Tetris_block4_reset3'));
...
function gameLoop() {
	...
	if (move_finished2==true){
	    ...
	    if (end2-start2>=11){
			...
			window.localStorage.setItem('Tetris_score',JSON.stringify(score_array));
			window.localStorage.setItem('Tetris_colour',Current_piece.colour);
			window.localStorage.setItem('Tetris_colour2',Current_piece.colour2);
			window.localStorage.setItem('Tetris_block1',JSON.stringify(Current_piece.block1));
			window.localStorage.setItem('Tetris_Block2',JSON.stringify(Current_piece.block2));
			window.localStorage.setItem('Tetris_Block3',JSON.stringify(Current_piece.block3));
			window.localStorage.setItem('Tetris_Block4',JSON.stringify(Current_piece.block4));
			window.localStorage.setItem('Tetris_block1_reset',JSON.stringify(Current_piece.block1_reset));
			window.localStorage.setItem('Tetris_block2_reset',JSON.stringify(Current_piece.block2_reset));
			window.localStorage.setItem('Tetris_block3_reset',JSON.stringify(Current_piece.block3_reset));
			window.localStorage.setItem('Tetris_block4_reset',JSON.stringify(Current_piece.block4_reset));
			if (Held_piece_class!==null){
				window.localStorage.setItem('Tetris_colour1',Held_piece_class.colour);
				window.localStorage.setItem('Tetris_colour21',Held_piece_class.colour2);
				window.localStorage.setItem('Tetris_block11',JSON.stringify(Held_piece_class.block1));
				window.localStorage.setItem('Tetris_block21',JSON.stringify(Held_piece_class.block2));
				window.localStorage.setItem('Tetris_block31',JSON.stringify(Held_piece_class.block3));
				window.localStorage.setItem('Tetris_block41',JSON.stringify(Held_piece_class.block4));
				window.localStorage.setItem('Tetris_block1_reset1',JSON.stringify(Held_piece_class.block1_reset));
				window.localStorage.setItem('Tetris_block2_reset1',JSON.stringify(Held_piece_class.block2_reset));
				window.localStorage.setItem('Tetris_block3_reset1',JSON.stringify(Held_piece_class.block3_reset));
				window.localStorage.setItem('Tetris_block4_reset1',JSON.stringify(Held_piece_class.block4_reset));
				window.localStorage.setItem('Tetris_holding5',true);
			}else{
				window.localStorage.setItem('Tetris_holding5',false);
			}
			window.localStorage.setItem('Tetris_colour3',Next_piece.colour);
			window.localStorage.setItem('Tetris_colour23',Next_piece.colour2);
			window.localStorage.setItem('Tetris_block13',JSON.stringify(Next_piece.block1));
			window.localStorage.setItem('Tetris_block23',JSON.stringify(Next_piece.block2));
			window.localStorage.setItem('Tetris_block33',JSON.stringify(Next_piece.block3));
			window.localStorage.setItem('Tetris_block43',JSON.stringify(Next_piece.block4));
			window.localStorage.setItem('Tetris_block1_reset3',JSON.stringify(Next_piece.block1_reset));
			window.localStorage.setItem('Tetris_block2_reset3',JSON.stringify(Next_piece.block2_reset));
			window.localStorage.setItem('Tetris_block3_reset3',JSON.stringify(Next_piece.block3_reset));
			window.localStorage.setItem('Tetris_block4_reset3',JSON.stringify(Next_piece.block4_reset));
			if (keyup==false){
				if (keys[87] || keys[38]){
					keyup=true;
					w_press=1;
			...
			if (moving==false){			
		        if (holding_change==true){
		            ...
		            var piece_num=Math.floor(Math.random()*Pieces_joined.length)
		            pieces_used=pieces_used+1
		            Next_piece=Pieces_joined[piece_num];
		            Pieces_joined.splice(piece_num,1)
